# This file is taken and adapted from https://github.com/Cartucho/mAP
...
################################################################################## CHANGED
# Get arguments from the command line so images directory can vary
parser = argparse.ArgumentParser()
parser.add_argument('--images_path', type=str, required=True)
args = parser.parse_args()
path_to_images_dir = args.images_path
################################################################################## END CHANGED
...
for tmp_file in txt_list:
  ...
  ################################################################################## CHANGED
  for fname in os.listdir(path_to_images_dir):
    ################################################################################## END CHANGED
    if fname.startswith(image_name):
      ## image found
      #print(fname)
      ################################################################################## CHANGED
      img = cv2.imread(path_to_images_dir + "/" + fname)
      ################################################################################## END CHANGED
